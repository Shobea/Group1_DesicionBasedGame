...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button:
                ...
                if (turn == 1) { // turn is equivalent to the 2nd layer
                    decision = 1; // decision is equivalent to the 1st layer
                    select=1;// select is equivalent to the button that is pressed in the 3rd layer
                }
                dialogueText();
                break;
            case R.id.button2:
    ...
    public void dialogueText() {
        if (decision == 1 && turn == 1) { //choice 1
            ...
            btn4.setText("Attack man ");
        } else if ( decision == 1 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4) { //1.1.1 UP TO 1.4.4
            buttonStateDisable();
        }
        ...
        else if ( decision == 2 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4) { //2.1.1 UP TO 2.4.4
            buttonStateDisable();
        }
        ...
        else if ( decision == 3 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4) { //3.1.4 UP TO 3.4.4
            buttonStateDisable();
        }
        ...
        else if ( decision == 4 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4) { //4.1.4 UP TO 4.4.4
            buttonStateDisable();
        }
        ...
        if (decision == 1 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4){
        ...
        }else if (decision == 2 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4){
        ...
        }else if (decision == 3 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4){
        ...
        }else if (decision == 4 || turn == 2 && option == 4 ||  select!=1 &&select!=2 &&select!=3 &&select!=4){
